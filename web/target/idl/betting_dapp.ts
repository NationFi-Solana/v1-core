export const idl = {
  ...
  instructions: [
    {
      name: 'add_new_bet',
      discriminator: [64, 2, 212, 134, 36, 20, 114, 204],
      accounts: [
        {
    ...
    },
    {
      ...
      discriminator: [217, 42, 110, 199, 65, 4, 91, 212],
      accounts: [
        {
    ...
    },
    {
      ...
      discriminator: [225, 88, 176, 139, 158, 113, 203, 37],
      accounts: [
        {
          name: 'global_state_account',
          writable: true,
    ...
    },
    {
      ...
      discriminator: [88, 46, 71, 114, 175, 162, 174, 116],
      accounts: [
        {
          name: 'user_sol_balance',
          writable: true,
          pda: {
            seeds: [
              {
                kind: 'const',
                value: [115, 111, 108, 95, 98, 101, 116, 95, 97],
              },
              {
                kind: 'account',
                path: 'user_authority',
    ...
    },
    {
      ...
      discriminator: [69, 105, 187, 47, 23, 46, 100, 137],
      accounts: [
        {
          name: 'user_sol_balance',
          writable: true,
          pda: {
            seeds: [
              {
                kind: 'const',
                value: [115, 111, 108, 95, 98, 101, 116, 95, 98],
              },
              {
                kind: 'account',
                path: 'user_authority',
    ...
    },
    {
      ...
      discriminator: [114, 90, 170, 208, 223, 41, 40, 160],
      accounts: [
        {
          name: 'program_state_account',
          writable: true,
    ...
    {
      name: 'place_sol_bet',
      discriminator: [160, 21, 21, 124, 17, 65, 59, 178],
      accounts: [
        {
          name: 'program_state_account',
          writable: true,
            ...
            seeds: [
              {
                kind: 'const',
                value: [
                  112, 114, 111, 103, 114, 97, 109, 95, 102, 117, 110, 100, 115,
                ],
              },
              {
                kind: 'account',
    ...
    },
    {
      ...
      discriminator: [203, 151, 175, 121, 203, 127, 188, 248],
      accounts: [
        {
          name: 'program_state_account',
          writable: true,
  ...
  accounts: [
    ...
    },
    {
      ...
      discriminator: [122, 27, 240, 221, 113, 56, 192, 45],
    },
  ],
  errors: [
    {
